const HeroSection = ({ Title, Subtitle, Paragraph, Img, reverseOrder }) => {
  return (
      ...
      >
        {!reverseOrder && (
          <div>
            ...
            <h2 className="font-roboto text-xl text-[#7CADF5]">{Subtitle}</h2>
        ...
        {reverseOrder && (
          <div>
            ...
            <p className="mt-3 text-justify text-lg text-white dark:text-neutral-400">
              {Paragraph}
            </p>
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <a
